    ...
    <div class="panorama-frame">
      <div class="panorama">
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          echo '<div class="image-wrapper" data-id="'.$count.'">';
          ...
          if ($descTopPx !== '' && $descLeftPx !== '') {
            $descId = "desc-".$count;
            echo '<div class="hotspot hotspot-desc" data-target="'.$descId.'" data-pos-top="'.htmlspecialchars($descTopPx).'" data-pos-left="'.htmlspecialchars($descLeftPx).'" style="--hotspot-top:0%; --hotspot-left:0%;">●</div>';
